...
#Together
ggplot(sim_df1) +
  geom_point(aes(t , coral), color = "red") +
  geom_line(aes(t , coral), linetype = "dashed") +
  geom_point(aes(t , algae), color = "blue") +
  geom_line(aes(t , algae), linetype = "dashed") +
  theme_bw()+
...
ggplot(sim_df) +
  ...
  geom_point(aes(t , algae), color = "blue") +
  geom_line(aes(t , algae), linetype = "dashed") +
  geom_point(aes(t , pfish), color = "purple") +
  geom_line(aes(t , pfish), linetype = "dashed") +
  theme_bw()+
  labs(x = "Time (years)",
       y = "Population Size")
